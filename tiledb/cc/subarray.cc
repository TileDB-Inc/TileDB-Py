    ...
    switch (tiledb_type) {
      ...
      case TILEDB_CHAR: {
        if (!py::isinstance<py::none>(r0) != !py::isinstance<py::none>(r1)) {
          TPY_ERROR_LOC(
            ...
            !py::isinstance<py::none>(r0) && !py::isinstance<py::none>(r1) &&
            !py::isinstance<py::str>(r0) && !py::isinstance<py::str>(r1) &&
            !py::isinstance<py::bytes>(r0) && !py::isinstance<py::bytes>(r1)) {
          TPY_ERROR_LOC(
        ...
        if (!py::isinstance<py::none>(r0) && !py::isinstance<py::none>(r0))
          subarray.add_range(
              dim_idx, r0.cast<std::string>(), r1.cast<std::string>());
      ...
      case TILEDB_DATETIME_AS: {
        ...
        case TILEDB_TIME_AS:
          ...
          auto dt0 =
              py::isinstance<py::int_>(r0) ? r0 : r0.attr("astype")(dtype);
          auto dt1 =
              py::isinstance<py::int_>(r1) ? r1 : r1.attr("astype")(dtype);

          // TODO, this is suboptimal, should define pybind converter
          if (py::isinstance<py::int_>(dt0) && py::isinstance<py::int_>(dt1)) {
            subarray.add_range(
                dim_idx, py::cast<int64_t>(dt0), py::cast<int64_t>(dt1));
          } else {
            auto darray = py::array(py::make_tuple(dt0, dt1));
            subarray.add_range(
                dim_idx, *(int64_t*)darray.data(0), *(int64_t*)darray.data(1));
          }
...
#else
bool has_label_range(const Context&, Subarray&, uint32_t) {
  return false;
}
#endif
...
void init_subarray(py::module& m) {
  py::class_<tiledb::Subarray>(m, "Subarray")
      ...
      .def(
          "_add_label_range",
          [](Subarray&, const Context&, const std::string&, py::tuple) {
            throw TileDBPyError(
                "Setting dimension label ranges requires libtiledb version "
                "2.15.0 or greater.");
          })
#endif
      ...
      .def(
          "_label_range_num",
          [](Subarray&, const Context&, const std::string&) {
            throw TileDBPyError(
                "Setting dimension label ranges requires libtiledb version "
                "2.15.0 or greater.");
          })
