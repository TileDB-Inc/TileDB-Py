...
class DomainIndexer:
    ...
    def __getitem__(self, idx):
        ...
        if isinstance(self.array, tiledb.libtiledb.SparseArrayImpl):
            return self.array._read_sparse_subarray(subarray, attr_names, attr_cond, layout)
        elif isinstance(self.array, tiledb.libtiledb.DenseArrayImpl):
            return self.array._read_dense_subarray(subarray, attr_names, attr_cond, layout, coords)
        else:
