...
void init_schema(py::module& m) {
          ...
          [](DimensionLabelSchema& dim_label_schema) -> py::object {
            ...
            switch (dim_type) {
              ...
              case TILEDB_STRING_ASCII: {
                // This should have already been caught in the check for a
                // mullptr above.
                throw TileDBError(
  ...
  py::class_<tiledb::ArraySchema>(m, "ArraySchema")
      ...
      .def_property(
          "_cell_order", &ArraySchema::cell_order, &ArraySchema::set_cell_order)

      .def_property(
          "_tile_order", &ArraySchema::tile_order, &ArraySchema::set_tile_order)
